...
Under License from Mike Diliberto
`;
  ...
  const printInvoice = () => {
    ...
    const invoiceContent = document.getElementById('printable-invoice-content');
    ...
    if (printWindow && invoiceContent) {
      ...
      // Fallback: use CSS to hide everything except the invoice
      const originalContents = document.body.innerHTML;
      const printContents = invoiceContent ? invoiceContent.innerHTML : '';
      ...
      {showPrintableInvoice && (
        <div className="fixed inset-0 bg-white z-50 overflow-auto print:relative print:inset-auto print:bg-transparent">
          <div className="max-w-4xl mx-auto p-8 print:p-0">
            ...
            {/* Invoice Content */}
            <div id="printable-invoice-content" className="bg-white border border-gray-300 print:border-none">
              {/* Header */}
